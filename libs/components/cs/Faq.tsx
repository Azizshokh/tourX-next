		...
		items: [
			{
				...
				answer: 'Each package shows its own inclusions, such as flights, hotels, local guides, duration, traveler limits, and destination details.',
			},
			{
				id: 'availability',
		...
		items: [
			{
				...
				answer: 'Cancellation rules vary by travel agent and package. Review the package details and confirm with the agent before booking.',
			},
			{
				id: 'documents',
				question: 'Which travel documents do I need?',
				answer: 'Document needs depend on destination and traveler nationality. Always check passport, visa, insurance, and voucher requirements early.',
			},
		],
	},
	{
		...
		items: [
			{
				...
				answer: 'Use the help page topics first, then contact the relevant travel agent or TourX support channel for booking-specific questions.',
			},
			{
				id: 'tourx',
				question: 'What is TourX?',
				answer: 'TourX is a travel marketplace for discovering tour packages, travel agents, saved trips, and traveler community content.',
			},
		],
	},
];
